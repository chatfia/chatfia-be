...
import com.project.chatfiabe.domain.user.jwt.constant.GrantType;
...
public class JwtTokenUtil {
    ...
    // New method: Extract user info from token
    public Claims getUserInfoFromToken(String token) {
        Claims claims = getTokenClaims(token);
        log.info("[getUserInfoFromToken] User info extracted from token");
        return claims;
    }
